        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы верим: каждый ребёнок способен влюбиться в искусство, если рассказать о нём живо и увлекательно. АртЭпоха — это дополнительные уроки истории искусств, где великие шедевры оживают через захватывающие истории их создания.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Школьник 5–9 класса, который познакомился с эпохой Возрождения, — это уже более разносторонняя личность. Он иначе смотрит на мир, развивает вкус и находит собственный путь в творчестве.
            </p>
          </div>
        </div>
      </div>
