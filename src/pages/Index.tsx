          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Искусство.</span>{" "}
                <span className="font-serif italic">История.</span>{" "}
                <span className="font-open-sans-custom not-italic">Вдохновение.</span>
              </h1>
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                дополнительные уроки для школьников 5–9 класса — откройте эпоху{" "}
                <span className="font-serif italic">Возрождения</span> и найдите себя в мире искусства
              </p>

              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">записаться на урок</ShinyButton>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Выберите удобный формат — от одного пробного урока до полного курса для класса или домашнего обучения.
              </p>
            </div>
            <BentoPricing />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Наша миссия — сделать историю искусств живой и увлекательной для каждого школьника.
              </p>
            </div>
            <AboutQuote />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              ...
              description="Хотите попробовать первый урок бесплатно или узнать подробнее о курсе? Заполните форму — мы ответим в течение одного рабочего дня."
              contactInfo={[
                {
                  icon: MailIcon,
                  label: "Почта",
                  value: "hello@artepokha.ru",
                },
                {
                  icon: PhoneIcon,
                  label: "Телефон",
